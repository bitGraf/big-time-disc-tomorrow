	...
	if (currentState == GameStates::Normal) {
		...
		if ((key == GLFW_KEY_ENTER) && (action == GLFW_PRESS)) {
			...
			switch (currentMenuItem) {
				case 0: {printf("Load level 1\n"); LevelLoader::loadLevel("../data/levels/level.lvl", "../data/levels/entity_maps/level1.enmp");currentState = GameStates::Normal; } break;
				case 1: {printf("Load level 2\n");LevelLoader::loadLevel("../data/levels/level2.lvl", "../data/levels/entity_maps/level2.enmp");currentState = GameStates::Normal;} break;
